...
public class TestUTF8 {
  ...
  public void testWritable(int arg1, int arg2) throws Exception {
    randomStringBound = arg1;
    iterations = arg2;
  ...
  @Test
  @Parameters(method = "testData")
  public void testGetBytes(int arg1, int arg2) throws Exception {
    randomStringBound = arg1;
    iterations = arg2;
    for (int i = 0; i < iterations; i++) {
  ...
  @Test
  @Parameters(method = "testData")
  public void testIO(int arg1, int arg2) throws Exception {
    randomStringBound = arg1;
    iterations = arg2;
